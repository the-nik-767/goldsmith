...
const Section2Main = () => {
    ...
    return (
        <>
            ...
            <div className=" text-center text-xl uppercase font-mono mt-20 mb-10 relative   "><h1 className='underline'>BEST SELLING PRODUCTS</h1></div>
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid:cols-4 gap-8 justify-center mx-8">
                {
                    arr.map((x) => {
                        return (
