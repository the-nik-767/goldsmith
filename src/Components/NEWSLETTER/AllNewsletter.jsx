          ...
          <div className="">
            <span>
              <input
                type="text"
                placeholder="E-mail"
                className="border-solid border border-gray-300 border-inherit px-8 py-1"
                required
              />
            </span>
            <span>
              <a
                className="bg-black  text-white  hover:bg-transparent  hover:border-solid border-2 border-black hover:text-black m-2 "
