    ...
    return (
        <>
            ...
            <div className="text-center">
                <div className="  text-5xl font-mono  mt-10 tracking-widest " style={{fontSize:'25px'}} ><h2>NEWSLETTER</h2></div>
                <p className='font-mono my-8 text-gray-700'>Sign up to our newsletter to receive exclusive offers.</p>
                <div className="">
