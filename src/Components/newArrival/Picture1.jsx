...
const Picture1 = ({openAddToCart, SetOpenAddToCart}) => {
    ...
    let arr = [
        ...
        { Img: 'https://images.unsplash.com/photo-1528121238716-306799520ddc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDF8fHxlbnwwfHx8fHw%3D', 'title': 'Embossed hoop earrings', 'price': '9099/-','label':'SELLING FAST' },
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid:cols-4 gap-8 justify-center" style={{ margin: '0px 20px' }}>
                {
                    arr.map((x) => {
                        return (
